...
CREATE TABLE "new_GuestTypeGroup" (
    ...
    "reportOnSiteTonight" BOOLEAN NOT NULL DEFAULT false,
    "reportOnSiteNow" BOOLEAN NOT NULL DEFAULT false,
    CONSTRAINT "GuestTypeGroup_siteId_fkey" FOREIGN KEY ("siteId") REFERENCES "Site" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
INSERT INTO "new_GuestTypeGroup" ("getAndReportArrivalTime", "id", "name", "order", "siteId") SELECT "getAndReportArrivalTime", "id", "name", "order", "siteId" FROM "GuestTypeGroup";
