...
function main() {
    ...
    while (successfulBookingCount < bookingNo) {
        ...
        const startDate = new Date(randomAvailableDate.date);
    ...
    const bookingGuestMap = [];
    bookings.forEach((booking, bookingIndex) => {
        const randomGuestNo = Math.ceil(Math.random() * 6);
        const guestsToAssignToBooking = [];
    ...
    bookings.forEach((booking, bookingIndex) => {
        ...
        const vehiclesToAssignToBooking = [];
